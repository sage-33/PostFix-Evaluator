...
//Test case that passes 1
	@Test(timeout = 5000)
	public void testPerformOperationSetDiff() {
		operator.setOperand(0, new Operand<Integer>(77));
		operator.setOperand(1, new Operand<Integer>(50));

		Operand<Integer> result = operator.performOperation();
		int value = result.getValue();
		assertEquals("Operator applied to 77 and 50 should produce 27.", 77 - 50, value);
	}

	// Test case that passes 2
	@Test(timeout = 5000)
	public void testPerformOperationSetDiff2() {
		operator.setOperand(0, new Operand<Integer>(500));
		operator.setOperand(1, new Operand<Integer>(69));

		Operand<Integer> result = operator.performOperation();
		int value = result.getValue();
		assertEquals("Operator applied to 500 and 69 should produce 431.", 500 - 69, value);
	}
	...
	public void testIllegalArgumentExceptionSetDiff() {
		...
		fail("Binary operator should not except input to position 8");
	}
}
